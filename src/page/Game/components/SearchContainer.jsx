  ...
  return (
    <div style={{ "margin-left": "40px" }}>
      ...
      {(searched || search) && (
        <>
          <div class="links">
            <p onClick={() => showResults(true, "Find out more about Vanuatu")}>
              Find out more about Vanuatu
            </p>
            <br />
            <p onClick={() => showResults(true, "Vanuatu- facts and figures")}>
              Vanuatu- facts and figures
            </p>
            <br />
            <p onClick={() => showResults(true, "Vanuatu- major cities")}>
